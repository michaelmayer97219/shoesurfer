...
function invokeRequest() {
	...
	if (getSecretAccessKey() == "AWS Secret Access Key") {
	  ...
	  return;
        ...
        var unsignedUrl = 'http://ecs.amazonaws.com/onca/xml?Service=AWSECommerceService&Version=2011-08-01&AssociateTag=pershofin-20&Operation=ItemSearch&SearchIndex=Books&Keywords=harry+potter';
        if (unsignedUrl == "") {
	...
	if (matches == null) {
	  ...
	  return;
       ...
       // document.getElementById("NameValuePairs").value = pairs.join("\n");
        ...
        // sort them and put them back together to get the string
        pairs.sort();
  ...
  return d.getUTCFullYear()+'-'
      ...
      function getAccessKeyId() {
          return 'AKIAIDF25W65W3YRQXTQ';
      }
      
      function getSecretAccessKey() {
          return '8NDDltJgk/v4iJyUZeRQt+YcoH7/Er8pVPGZ98Xo';        
      }
